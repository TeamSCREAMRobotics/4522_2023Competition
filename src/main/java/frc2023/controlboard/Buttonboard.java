...
public class Buttonboard {
    ...
    public Buttonboard(int portA, int portB) {
        ...
        buttonMap.put(1, new ButtonboardPort(0, 4));
        buttonMap.put(2, new ButtonboardPort(0, 1));
        buttonMap.put(3, new ButtonboardPort(0, 9));
        buttonMap.put(4, new ButtonboardPort(0, 2));
        buttonMap.put(5, new ButtonboardPort(0, 3));
        buttonMap.put(6, new ButtonboardPort(0, 12));
        buttonMap.put(7, new ButtonboardPort(0, 8));
        ...
        switchMap.put(1, new ButtonboardPort(1, 6, false));
        switchMap.put(2, new ButtonboardPort(1, 10, false));
        switchMap.put(3, new ButtonboardPort(1, 8));
        switchMap.put(4, new ButtonboardPort(1, 11));
